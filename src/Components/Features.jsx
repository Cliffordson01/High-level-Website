    ...
    <div className="relative size-full">
      ...
      >
        <div>
          ...
          {description && (
            <p
              className="mt-3 max-w-64 taxt-xs
          md:text-base"
            >
              {description}
            </p>
    ...
    <section className="bg-black pb-52">
      <div className="container mx-auto px-3 md:px-10">
        <div className="px-5 py-32">
          ...
          <p
            className="max-w-md font-circular-web
        ...
        <BentoTilt
          className="border-hsla relative mb-7 h-96
      ...
      gap-7"
        ...
        md:col-span-1 md:ms-0"
          ...
          dimension of play to social interaction 
          for web3 comunities."
            />
          </BentoTilt>
          <BentoTilt className="bento-tilt_1 me-14 md:col-span-1 md:me-0">
            <BentoCard
              ...
              description="A cross-world Ai Agent - elevating your gameplay to be
